...
const styles = StyleSheet.create({
  ...
  importChoice: { minHeight: 52, borderRadius: 15, paddingHorizontal: 16, justifyContent: "center", marginBottom: 10, backgroundColor: "#f1f1f3" }, importChoiceSelected: { backgroundColor: "#fff1e5" }, importChoiceText: { color: colors.primary, fontFamily: "MiSans-Medium", fontSize: 16 }, importChoiceTextSelected: { fontFamily: "MiSans-Semibold" }, dialogActions: { flexDirection: "row", justifyContent: "flex-end", gap: 6, marginTop: 3 }, dialogAction: { minWidth: 62, minHeight: 34, justifyContent: "center", alignItems: "center" }, cancelText: { color: colors.textSecondary, fontFamily: "MiSans-Medium", fontSize: 16 }, confirmText: { color: colors.primary, fontFamily: "MiSans-Semibold", fontSize: 16 }, confirmTextDisabled: { color: colors.textTertiary },
